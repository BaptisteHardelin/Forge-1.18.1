package fr.babaprog.testmod.item.custom;

import fr.babaprog.testmod.util.ModTags;
...
public class DowsingRodItem extends Item {
    ...
    public InteractionResult useOn(UseOnContext pContext) {
        if(pContext.getLevel().isClientSide()) {
            ...
            if(!foundBlock) {
                player.sendMessage(new TextComponent("item.testmod:dowsing_rod.no_valuables"), player.getUUID());
            }
        }
